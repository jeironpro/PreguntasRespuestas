...
function cargarPregunta(categoria = "") { 
    ...
    const respuesta_correcta = preguntaAleatoria.respuesta_correcta;
    const iconoCategoria = categorias[categoriaPregunta]; 

    const contenedorPreguntas = document.getElementById('contenedor_preguntas');
    contenedorPreguntas.className = "contenedor_preguntas";
    contenedorPreguntas.classList.add(categoriaPregunta.toLowerCase());
    ...
    respuestas.forEach((respuesta, index) => {
        ...
        li.classList = "respuesta";
        li.onclick = function() {
            const seleccionada = document.querySelector(".seleccionado");
    ...
    if (categoria !== "") { 
        const enlaceCategoria = document.querySelector(".lista.active"); 
        if (enlaceCategoria) { 
            enlaceCategoria.classList.remove("active"); 
        } 
        const enlace = document.querySelector(`[onclick="cargarPregunta('${categoria}')]`); 
